...
export const keyTexture = (opts) => {
  ...
  // console.log('L?', l?.chars[key], mainChar, l.fontFamily);
  // console.log('Char', l.code, key, String.fromCharCode(parseInt(mainChar, 16)), mainChar, subChar, l.fontFamily);
  ...
  if (mainChar["top"]) {
    ...
    ctx.fillText(mainChar,l.offsetX + ent_off_x,
  ...
  //     link.href = url;
  //     link.download = `${opts.code}_texture.png`; // đặt tên file tùy ý
