...
static specialKeyMap = {
  ...
  static getKeyCode(code) {
    ...
    if (this.specialKeyMap[code]) return this.specialKeyMap[code];
    
    // ✅ Ưu tiên 2: qmk_codes (gốc)
    if (qmk_codes[code]) return qmk_codes[code];
    
    // ✅ Ưu tiên 3: fallback → dùng nguyên code
    return code;
  }
